<div class="places index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('iscoutid'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($place['Place']['classname']); ?>&nbsp;</td>
		<td><?php echo h($place['Place']['visible']); ?>&nbsp;</td>
		<td><?php echo h($place['Place']['img']); ?>&nbsp;</td>
		<td><?php echo h($place['Place']['metatitle']); ?>&nbsp;</td>
		<td><?php echo h($place['Place']['metadescription']); ?>&nbsp;</td>
		<td><?php echo h($place['Place']['iscoutid']); ?>&nbsp;</td>
